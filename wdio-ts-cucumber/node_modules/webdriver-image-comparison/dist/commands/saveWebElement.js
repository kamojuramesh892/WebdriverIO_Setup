...
export default async function saveWebElement({ methods, instanceData, folders, element, tag, saveElementOptions, }) {
    ...
    if (canUseBidiScreenshot(methods) && !isMobile && !enableLegacyScreenshotMethod) {
        ...
        const rect = await methods.getElementRect((await element).elementId);
        ...
        const takeBiDiElementScreenshot = (origin) => takeBase64BiDiScreenshot({ bidiScreenshot, getWindowHandle, origin, clip });
        try {
